const LocationService = {
  getUserLocation: function(callback) {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        error => {
          ErrorNotifier.show(
              ...
              'Pastikan GPS aktif dan izin lokasi telah diberikan. Menampilkan jadwal untuk lokasi default.'
          );
      ...
      ErrorNotifier.show(
          ...
          'Menampilkan jadwal untuk lokasi default.'
      );
  ...
  getAltitude: function(lat, lng, callback) {
    ...
    fetch(url)
      ...
      .catch(error => {
        ErrorNotifier.show('Gagal mengambil data ketinggian.', 'Perhitungan mungkin kurang akurat.', 'info');
  ...
  reverseGeocode: function(lat, lng, callback) {
    ...
    fetch(url)
      ...
      .catch(error => {
        ErrorNotifier.show('Gagal mengambil nama lokasi.', 'Periksa koneksi internet Anda.', 'info');
